...
import (
	...
	"github.com/mendezdev/bookstore_users-api/utils/crypto_utils"
	"github.com/mendezdev/bookstore_users-api/utils/date_utils"
	"github.com/mendezdev/bookstore_utils-go/rest_errors"
)

var (
	//UsersService is a variable for the interface
